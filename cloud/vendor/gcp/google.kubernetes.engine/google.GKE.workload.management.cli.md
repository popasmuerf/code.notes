...
##List Kubernetes Pods/Sevice/Replica
...
```
michaelbrown172@cloudshell:~ (networking-lab-312020)$ kubectl get services
NAME                   TYPE           CLUSTER-IP    EXTERNAL-IP      PORT(S)          AGE
hello-world-rest-api   LoadBalancer   10.24.5.139   35.243.222.109   8080:32455/TCP   25h
kubernetes             ClusterIP      10.24.0.1     <none>           443/TCP          26h
michaelbrown172@cloudshell:~ (networking-lab-312020)$ kubectl delete service hello-world-rest-api
service "hello-world-rest-api" deleted
michaelbrown172@cloudshell:~ (networking-lab-312020)$ kubectl get deployments
NAME                   READY   UP-TO-DATE   AVAILABLE   AGE
hello-world-rest-api   1/1     1            1           25h
michaelbrown172@cloudshell:~ (networking-lab-312020)$ kubectl delete deployment hello-world-rest-api
deployment.apps "hello-world-rest-api" deleted
michaelbrown172@cloudshell:~ (networking-lab-312020)$ gcloud container clusters list
NAME           LOCATION    MASTER_VERSION   MASTER_IP    MACHINE_TYPE  NODE_VERSION     NUM_NODES  STATUS
foo-cluster-1  us-east1-c  1.18.17-gke.100  34.73.95.86  e2-medium     1.18.17-gke.100  3          RUNNING
michaelbrown172@cloudshell:~ (networking-lab-312020)$ gcloud container clusters delete foo-cluster-1
ERROR: (gcloud.container.clusters.delete) One of [--zone, --region] must be supplied: Please specify location.
michaelbrown172@cloudshell:~ (networking-lab-312020)$ gcloud container clusters delete foo-cluster-1 --zone us-east1-c
The following clusters will be deleted.
 - [foo-cluster-1] in [us-east1-c]

Do you want to continue (Y/n)?  Y

Deleting cluster foo-cluster-1...⠼
