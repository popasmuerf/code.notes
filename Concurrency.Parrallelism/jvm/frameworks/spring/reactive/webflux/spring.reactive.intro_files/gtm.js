...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return\"2500002\"!=TH_CORE_VARS.additional.request[0].user.id?",["escape",["macro",21],8,16],":",["escape",["macro",22],8,16],"})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return TH_CORE_VARS.additional.model[0].metaData.section})();"]
    },{
...
return null},yd=!1;if(H.querySelectorAll)try{var zd=H.querySelectorAll(":root");zd&&1==zd.length&&zd[0]==H.documentElement&&(yd=!0)}catch(a){}var sd=yd;var Nd={},K=null,Od=Math.random();Nd.C="GTM-K25QL22";Nd.Ub="8j2";Nd.Nh="";var Pd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Qd="www.googletagmanager.com/gtm.js";
var Rd=Qd,Sd=null,Td=null,Ud="//www.googletagmanager.com/a?id="+Nd.C+"&cv=304",Vd={},Wd={},Xd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
f++}}return 0};var gl=!!F.MutationObserver,hl=void 0,il=function(a){if(!hl){var b=function(){var c=H.body;if(c)if(gl)(new MutationObserver(function(){for(var e=0;e<hl.length;e++)I(hl[e])})).observe(c,{childList:!0,subtree:!0});else{var d=!1;Qc(c,"DOMNodeInserted",function(){d||(d=!0,I(function(){d=!1;for(var e=0;e<hl.length;e++)I(hl[e])}))})}};hl=[];H.body?b():I(b)}hl.push(a)};
var tl=function(){var a=H.body,b=H.documentElement||a&&a.parentElement,c,d;if(H.compatMode&&"BackCompat"!==H.compatMode)c=b?b.clientHeight:0,d=b?b.clientWidth:0;else{var e=function(f,h){return f&&h?Math.min(f,h):Math.max(f,h)};oc(7);c=e(b?b.clientHeight:0,a?a.clientHeight:0);d=e(b?b.clientWidth:0,a?a.clientWidth:0)}return{width:d,height:c}},ul=function(a){var b=tl(),c=b.height,d=b.width,e=a.getBoundingClientRect(),f=e.bottom-e.top,h=e.right-e.left;return f&&h?(1-Math.min((Math.max(0-e.left,0)+Math.max(e.right-
d,0))/h,1))*(1-Math.min((Math.max(0-e.top,0)+Math.max(e.bottom-c,0))/f,1)):0},vl=function(a){if(H.hidden)return!0;var b=a.getBoundingClientRect();if(b.top==b.bottom||b.left==b.right||!F.getComputedStyle)return!0;var c=F.getComputedStyle(a,null);if("hidden"===c.visibility)return!0;for(var d=a,e=c;d;){if("none"===e.display)return!0;var f=e.opacity,h=e.filter;if(h){var k=h.indexOf("opacity(");0<=k&&(h=h.substring(k+8,h.indexOf(")",k)),"%"==h.charAt(h.length-1)&&(h=h.substring(0,h.length-1)),f=Math.min(h,
f))}if(void 0!==f&&0>=f)return!0;(d=d.parentElement)&&(e=F.getComputedStyle(d,null))}return!1};var Dl=F.clearTimeout,El=F.setTimeout,V=function(a,b,c){if(Bg()){b&&I(b)}else return Mc(a,b,c)},Fl=function(){return new Date},Gl=function(){return F.location.href},Hl=function(a){return Me(Oe(a),"fragment")},Il=function(a){return Ne(Oe(a))},Jl=function(a,b){return ye(a,b||2)},Kl=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=Mk(a)):d=Mk(a);return d},Ll=function(a,b){F[a]=b},W=function(a,b,c){b&&
...
Z.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(x){for(var B=[],A=x.split(","),y=0;y<A.length;y++){var C=Number(A[y]);if(isNaN(C))return[];n.test(A[y])||B.push(C)}return B}function c(){var x=0,B=0;return function(){var A=tl(),y=A.height;x=Math.max(v.scrollLeft+A.width,x);B=Math.max(v.scrollTop+y,B);return{yg:x,zg:B}}}function d(){q=W("self");
u=q.document;v=u.scrollingElement||u.body&&u.body.parentNode;z=c()}function e(x,B,A,y){var C=l(B),G={},L;for(L in C){G.Ma=L;if(C.hasOwnProperty(G.Ma)){var P=Number(G.Ma);x<P||(Kl({event:"gtm.scrollDepth","gtm.scrollThreshold":P,"gtm.scrollUnits":A.toLowerCase(),"gtm.scrollDirection":y,"gtm.triggers":C[G.Ma].join(",")}),$k("sdl",B,function(U){return function(O){delete O[U.Ma];return O}}(G),{}))}G={Ma:G.Ma}}}function f(){var x=z(),B=x.yg,A=x.zg,y=B/v.scrollWidth*100,C=A/v.scrollHeight*100;e(B,"horiz.pix",
r.Sb,t.Nd);e(y,"horiz.pct",r.Rb,t.Nd);e(A,"vert.pix",r.Sb,t.Wd);e(C,"vert.pct",r.Rb,t.Wd);Zk("sdl","pending",!1)}function h(){var x=250,B=!1;u.scrollingElement&&u.documentElement&&q.addEventListener&&(x=50,B=!0);var A=0,y=!1,C=function(){y?A=El(C,x):(A=0,f(),Pl("sdl")&&!a()&&(Rc(q,"scroll",G),Rc(q,"resize",G),Zk("sdl","init",!1)));y=!1},G=function(){B&&z();A?y=!0:(A=El(C,x),Zk("sdl","pending",!0))};return G}function k(x,B,A){if(B){var y=b(String(x));$k("sdl",A,function(C){for(var G=0;G<y.length;G++){var L=
String(y[G]);C.hasOwnProperty(L)||(C[L]=[]);C[L].push(B)}return C},{})}}function l(x){return al("sdl",x,{})}function p(x){I(x.vtp_gtmOnSuccess);var B=x.vtp_uniqueTriggerId,A=x.vtp_horizontalThresholdsPixels,y=x.vtp_horizontalThresholdsPercent,C=x.vtp_verticalThresholdUnits,G=x.vtp_verticalThresholdsPixels,L=x.vtp_verticalThresholdsPercent;switch(x.vtp_horizontalThresholdUnits){case r.Sb:k(A,B,"horiz.pix");break;case r.Rb:k(y,B,"horiz.pct")}switch(C){case r.Sb:k(G,B,"vert.pix");break;case r.Rb:k(L,
B,"vert.pct")}Pl("sdl")?al("sdl","pending")||(w||(d(),w=!0),I(function(){return f()})):(d(),w=!0,v&&(Ql("sdl"),Zk("sdl","pending",!0),I(function(){f();if(a()){var P=h();Qc(q,"scroll",P);Qc(q,"resize",P)}else Zk("sdl","init",!1)})))}var n=/^\s*$/,r={Rb:"PERCENT",Sb:"PIXELS"},t={Wd:"vertical",Nd:"horizontal"},q,u,v,w=!1,z;(function(x){Z.__sdl=x;Z.__sdl.b="sdl";Z.__sdl.g=!0;Z.__sdl.priorityOverride=0})(function(x){x.vtp_triggerStartOption?p(x):ek(function(){p(x)})})}();
...
Z.a.cid=["google"],function(){(function(a){Z.__cid=a;Z.__cid.b="cid";Z.__cid.g=!0;Z.__cid.priorityOverride=0})(function(){return Nd.C})}();
